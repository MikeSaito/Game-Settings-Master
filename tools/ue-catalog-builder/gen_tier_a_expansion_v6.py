...
from tier_a_v6_families import FAMILY, SUFFIX, build_family_entry  # noqa: E402
from tier_a_v6_lumen import LUMEN  # noqa: E402
from tier_a_v6_misc import build_misc  # noqa: E402

OUT = ROOT / "data" / "tier_a_expansion_v6.json"
INDEX = ROOT.parents[1] / "src-tauri" / "catalog" / "ue_reference_index.json"
DATA = ROOT / "data"
