...
import type { FontScale, SettingsLanguage, ThemeMode } from "../../lib/appSettings";
        ...
        <div className="space-y-5">
          <section className="space-y-2">
            ...
            <SegmentControl
              ...
              onChange={(value) => setLanguage(value as SettingsLanguage)}
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2">
              <div>
                <div className="text-sm font-medium text-[var(--color-text)]">{t("more.defaultPanel")}</div>
                <div className="text-xs text-[var(--color-text-muted)]">{t("more.defaultPanelDesc")}</div>
              </div>
              <SegmentControl
                value={settings.defaultEditorPanel}
                onChange={(value) => setDefaultEditorPanel(value as EditorPanel)}
                ariaLabel={t("more.defaultPanel")}
                className="w-full"
                options={[
                  { value: "basic", label: t("more.basic") },
