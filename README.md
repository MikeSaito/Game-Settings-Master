...
Готовые наборы настроек для разобранных автором игр (например Forza Horizon 6) — применение в один клик с предпросмотром diff. Видно каждую правку в конфигах.
...
* [Скачать установщик](https://github.com/MikeSaito/Game-Settings-Master/releases/latest/download/Game-Settings-Master_0.3.0_x64-setup.exe)
