...
pub use apply_dir::apply_changes_to_dir;
pub use apply_targets::{apply_custom_to_dir, apply_custom_to_targets};
...
mod tests {
        ...
        let changes = crate::core::models::CustomChanges {
            files: std::collections::HashMap::from([(
                ...
                std::collections::HashMap::from([(
                    ...
                    std::collections::HashMap::from([("r.Tonemapper.Sharpen".to_string(), "0.75".to_string())]),
                )]),
            )]),
            ..Default::default()
        };
    ...
    fn apply_changes_rejects_traversal_filename() {
        ...
        let err =
            apply_changes_to_dir(dir.path(), &files, &std::collections::HashMap::new(), 1920, 1080)
                .unwrap_err();
    ...
    fn apply_changes_rejects_ini_value_injection() {
        ...
        let files = std::collections::HashMap::from([(
            ...
            std::collections::HashMap::from([(
                "SystemSettings".to_string(),
                std::collections::HashMap::from([("r.Safe".to_string(), "1\nInjected=True".to_string())]),
            )]),
        )]);
        let err =
            apply_changes_to_dir(dir.path(), &files, &std::collections::HashMap::new(), 1920, 1080)
